...
function Hero() {
    return (
        <div className="h-[100vh] text-white/90 hero-bg relative flex flex-col justify-center items-center">
            <div className='flex justify-center items-center gap-x-2 mx-auto' data-aos="fade-down" data-aos-duration="2000">
            ...
            <div className='flex flex-col my-6 text-center justify-center items-center' data-aos="fade-up" data-aos-duration="2000">
            ...
            <div data-aos="fade-up" data-aos-duration="2000">
                <button className='btn'><a href="https://dribbble.com/YASHpAthak" target='black'><p className='flex justify-center items-center gap-x-2'>My Work <ArrowUpRight /></p></a></button>
            </div>
        </div>
    )
}
