...
function Footer() {
    return (
        <div className="h-auto text-white mt-20">
            <div className="flex flex-col gap-y-6 text-[25px] text-center">
                ...
                <div>
                    <button className='btn'><a href="https://www.linkedin.com/in/yash-pathak-10a6031b6/" target='black'><p className='flex justify-center items-center gap-x-1 cursor-pointer'>Hire Me <ArrowUpRight /></p></a></button>
                </div>
            </div>
            <div className='mt-24 text-[40px] md:text-[60px] text-center bg-clip-text'><span className='blur-sm'>CONTACT ME</span></div>
            <hr />
            <div className='py-16 text-center flex flex-col md:flex-row md:px-4 md:mx-0 md:gap-x-6 justify-center items-center relative gap-y-20'>
                ...
                <div className='flex flex-col gap-y-6 items-center w-full'>
                    ...
                    <div className='flex gap-x-4'>
                       <a className='hover:scale-110 ease-in-out duration-500 cursor-pointer' href="https://www.linkedin.com/in/yash-pathak-10a6031b6/" target='black'><Linkedin/></a>
                        <a className='hover:scale-110 ease-in-out duration-500 cursor-pointer' href='https://github.com/Yash245Pathak' target='black'><GitHub /></a>
                        <a className='hover:scale-110 ease-in-out duration-500 cursor-pointer' href='https://www.instagram.com/__yash__pathak_/' target='black'><Instagram /></a>
                    </div>
                </div>
            </div>
